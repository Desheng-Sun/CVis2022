...
export default function SkeletonChart(w, h){
    ...
    function drawChart(){
      if(JSON.stringify(data) === '{}') return 
        ...
        const svg = d3.select('#skeleton-chart')
                        .append('svg')                    
                        .attr("width", svgWidth)
        ...
        const wrapper = svg.append('g').attr('transform', `translate(0, 0)`).attr('class', 'skeleton-wrapper');
        ...
        nodeG.append('circle').attr('r', 2).attr('fill', 'white').attr('cx', 0).attr('cy', 0).attr('fill', (d, index) => innerCirlceColor[index %2])
    ...
    return <div id="skeleton-chart"  style={{ width: "100%", height: "96%" }}></div>
}